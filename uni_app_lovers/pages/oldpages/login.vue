	...
	<view class="login">
		<view class="login-main">
			...
			<view class="login-list flex border-all">
				...
				<view class="login-input">
					<input type="password" maxlength="6" placeholder="请输入密码" class="is-input1 " v-model="pwd" />
				</view>		
			</view>
		...
		<view class="login-footer">
			...
			<view class="footer-other flex">
				<view class="other-list">
					<image src="../static/images/ic-QQ@2x.png" mode="aspectFill" @tap="login_qq()"></image>
				</view>
				<view class="other-list">
					<image src="../static/images/ic-weixin@2x.png" mode = "aspectFill" @tap="login_weixin()"></image>
				</view>
			</view>
		</view>
	</view>
